...
export default function HomePage() {
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-gradient)' }}>
      {/* ── Nav ──────────────────────────────────────────── */}
      <nav className="fixed top-0 left-0 right-0 z-50 panel" style={{ borderRadius: 0, borderTop: 0, borderLeft: 0, borderRight: 0 }}>
      ...
      <section className="min-h-[90vh] flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.1] mb-5" style={{ color: 'var(--text-primary)' }}>
            The AI that{' '}
            <span style={{ background: 'linear-gradient(135deg, var(--accent), #2dd4bf)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              actually builds
            </span>
            <br />
            Roblox games
      ...
      <section id="features" className="py-28 px-6" style={{ background: 'var(--bg-surface-solid)' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div key={i} className="panel p-6 hover:-translate-y-0.5 transition-transform" style={{ background: 'var(--bg-elevated)' }}>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className={`panel p-8 text-left flex flex-col ${i === 1 ? 'ring-2' : ''}`} style={{ borderColor: i === 1 ? 'var(--accent)' : undefined, background: 'var(--bg-elevated)' }}>
