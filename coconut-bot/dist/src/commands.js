...
exports.botCommands = [
    {
        data: new discord_js_1.SlashCommandBuilder()
            ...
            .addStringOption((opt) => opt.setName('type').setDescription('Type of grant')
            .setRequired(true)
            .addChoices({ name: 'premium', value: 'premium' }))
            .addStringOption((opt) => opt.setName('email').setDescription('The user\'s email on Coconut AI').setRequired(true))
            .addStringOption((opt) => opt.setName('duration').setDescription('How long?')
            .setRequired(true)
            .addChoices({ name: 'monthly (30 days)', value: 'monthly' }, { name: 'lifetime (never expires)', value: 'lifetime' })),
